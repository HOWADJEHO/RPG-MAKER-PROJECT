...
ConfigManager.wasdMap = {
	...
	40: 'down', 90: 'up', 81: 'left', 83: 'down', 68: 'right', 74: 'ok',
...
Window_KeyConfig._keyLayout = [
	...
	'Orig', 'Pg.P', ' ', '#pD/', '*', '#pD-', ' ', 'A', 'Z', 'E', 'R', 'T', 'Y',
	'U', 'I', 'O', 'P', '[', ']', '\\', 'Suppr', 'Fin', 'Pg.S', '#pD7', '#pD8',
	'#pD9', '+', ' ', 'Q', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L', 'M', "'",
	'Entree', 'Enter', ' ', ' ', ' ', '#pD4', '#pD5', '#pD6', '+', 'Shift',
	'Shift', 'W', 'X', 'C', 'V', 'B', 'N', ',', ';', '.', '/', 'Shift', 'Shift',
	' ', '↑', ' ', '#pD1', '#pD2', '#pD3', 'En', ' ', ' ', ' ', 'Espace', 'Space',
